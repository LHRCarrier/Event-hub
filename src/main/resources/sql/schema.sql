...
CREATE TABLE IF NOT EXISTS users (
    ...
    wallpaper_type VARCHAR(20) DEFAULT 'GRADIENT' COMMENT '壁纸类型：GRADIENT-渐变 COLOR-纯色 IMAGE-图片',
    wallpaper_value VARCHAR(1000) DEFAULT '#1e88e5' COMMENT '壁纸值：渐变ID、颜色值或图片URL',
