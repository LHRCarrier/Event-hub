...
public class CommunityServiceImpl implements CommunityService {
    ...
    public CommunityResponse getCommunityById(Integer communityId) {
        ...
        if (community == null) {
            throw new BusinessException(404, "Community not found");
        }
        return convertToResponse(community);
    }
    ...
    public Integer countEvents(Integer communityId) {
        LambdaQueryWrapper<com.bubbles.pojo.entity.Event> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(com.bubbles.pojo.entity.Event::getCommunityId, communityId);
